...
ActiveRecord::Schema.define(version: 20180121093333) do
  ...
  create_table "enquireys", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.string "phone"
    t.string "locality"
    t.integer "user_id"
